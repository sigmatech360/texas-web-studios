            ...
            <div className="row justify-content-center">
                <div className="col-lg-10">
                    <div className="mobileappdev-team-head">
                        <h2 className='mainhead'>Hire Mobile App Developers That <span>Cover Success From All Angles</span></h2>
                        <p>Our skilled team uses Swift, Kotlin, React Native, and Flutter to create high-quality iOS and Android apps that perform beautifully.</p>
                    </div>
                </div>
            </div>
            <div className="row">
