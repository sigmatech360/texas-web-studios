            ...
            <div className="row justify-content-center">
                <div className="col-lg-10">
                    <div className="webapp-portfolio-head">
                        <h6 className='minihead text-white'>OUR PROCESS</h6>
                        <h2 className='mainhead text-white'>Our Latest Web App Projects</h2>
                        <p>From Startups To Enterprises, We’ve Built Dynamic Web Applications That Empower Businesses Across Industries.</p>
                    </div>
                </div>
            </div>
            <div className="row">
