...
import process1 from "../../assets/images/services/ecommercedevelopment/process1.webp";
import process2 from "../../assets/images/services/ecommercedevelopment/process2.webp";
import process3 from "../../assets/images/services/ecommercedevelopment/process3.webp";
import process4 from "../../assets/images/services/ecommercedevelopment/process4.webp";
import process5 from "../../assets/images/services/ecommercedevelopment/process5.webp";
import process6 from "../../assets/images/services/ecommercedevelopment/process6.webp";
    ...
    <section className='our-process-sec'>
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-lg-6">
                    <div className="our-process-text phasefive pe-5">
                        <h4>Testing & Quality Assurance</h4>
                        <p>Before launch, every aspect of your website undergoes rigorous testing. We verify functionality, loading speed, checkout flow, and browser compatibility. From mobile responsiveness to data security, our experts ensure your store meets the highest standards of performance and user satisfaction.</p>
                    </div>
                </div>
                <div className="col-lg-6">
                    <div className="our-process-img ps-5">
                        <img src={process5} alt="img" />
                    </div>
                </div>
                <div className="col-lg-6">
                    <div className="our-process-img phaseoneimg pe-5">
                        <img src={process6} alt="img" />
                    </div>
                </div>
                <div className="col-lg-6">
                    <div className="our-process-text phasesix ps-5">
                        <h4>Launch & Ongoing Support</h4>
                        <p>Once your store is live, we continue to support you with updates, maintenance, and performance insights. Our partnership doesn’t end at launch; we then begin to track results, make improvements, and help you scale, ensuring your business thrives in the competitive online market.</p>
                    </div>
                </div>
            </div>
        </div>
